          ...
          <div className="row text-center" key={workout.id}>
            <div className="col-xs-12">
              <div className="subscribe-details text-center">
                  ...
                  <p className="col-xs-6 text-center action-links"><a href="#" onClick={Actions.chatScene(workout.trainer.sessionInfo.sessionId, trainerName)}>Chat With {trainerName}</a></p>
                </div>
            </div>
          </div>
