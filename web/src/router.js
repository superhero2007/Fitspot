    ...
    <Provider store={store}>
      <Router history={history}>
        ...
        <Route path="/booking">
         ...
         <Route path="/calendar">
          <Route path="activities/" component={Calendar.CalendarScene} />
         </Route>
         <Route path="/subscribe">
          <Route path="add-subscription/" component={Subscription.SubscriptionScene} />
        </Route>
        <Route path="/profile">
          <IndexRoute component={Profile.ProfileScene}/>
        ...
        <Route path="/chat">
          <Route path="message/" component={Chat.ChatScene} />
          <Route path="message/:sessionId/:name" component={Chat.ChatScene} />
        </Route>
      </Router>
    </Provider>
  );
