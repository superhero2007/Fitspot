...
import {FitnessGoalsScene,ProfileScene,EditProfileScene,TrainingCadenceScene,TrainerStylesScene,BodyFocusScene,,FavoriteLowIntensityScene,FavoriteHighIntensityScene} from '@Profile/scenes'
...
module.exports = <Scene  key="myTabBar" tabs tabBarStyle={{alignItems: 'center',justifyContent: 'center', alignSelf:'center',backgroundColor: '#fffff'}}></Scene>
          ...
          <Scene key="loginModal" direction="vertical">
            ...
            <Scene key="trainerInformation" title='About You' component={TrainerInformationScene} hideNavBar/>
            <Scene key="trainerAboutYou" title='About You' component={TrainerAboutYouScene} hideNavBar/>
          </Scene>
          ...
          <Scene key="subscribe" tabIcon={TabIcon} icon={TabIcon} leftButtonIconStyle={{ tintColor: DEFAULT_GREEN_COLOR}} titleStyle={{    fontFamily: FONT_DAYTONA_BOLD,
              fontSize: 14,color : "#000"}} >
            <Scene key="subscribeNow" title='Subscribe Now' component={SubscribeNowScene} navigationBarStyle={{backgroundColor: 'rgba(0,0,0,0)'}}/>
          ...
          fontSize: 14,color : "#000"}} hideNavBar={false}/>
            ...
            <Scene key='favLowIntensity' component={FavoriteLowIntensityScene} title='Favorite Low Intensity Workouts' titleStyle={{fontFamily: FONT_DAYTONA_BOLD,
              fontSize: 14,color : "#000"}}/>
            <Scene key='favHighIntensity' component={FavoriteHighIntensityScene} title='Favorite High Intensity Workouts' titleStyle={{fontFamily: FONT_DAYTONA_BOLD,
              fontSize: 14,color : "#000"}}/>
            <Scene key="trainingCadence" title='Fitness Level' component={TrainingCadenceScene} titleStyle={{fontFamily: FONT_DAYTONA_BOLD, fontSize: 14,color : "#000"}} />
            <Scene key="trainerStyles" title='Trainer Preferences' component={TrainerStylesScene} titleStyle={{fontFamily: FONT_DAYTONA_BOLD, fontSize: 14,color : "#000"}} />
            <Scene key='fitnessGoals' component={FitnessGoalsScene} title='Fitness Goals' titleStyle={{fontFamily: FONT_DAYTONA_BOLD, fontSize: 14,color : "#000"}} />
            <Scene key="bodyFocus" component={BodyFocusScene}  title="Body Focus" titleStyle={{fontFamily: FONT_DAYTONA_BOLD, fontSize: 14,color : "#000"}}/>
