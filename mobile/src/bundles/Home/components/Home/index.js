    ...
    return (
      <TouchableHighlight onPress={() => Actions.confirmTrainerWorkoutHome({workoutItem: rowData})}>
        ...
        <View>
          ...
          <Text style={{fontFamily:FONT_DAYTONA_SEMIBOLD,fontSize:12,letterSpacing:-.1,color:'white'}}>{moment(rowData.dtStart).format('hmmA ddd')} with {rowData.user.firstName} {rowData.user.lastName}</Text>
