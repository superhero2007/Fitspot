...
class EditBookingContainer extends Component {
  ...
  render() {
    return (
      <EditBooking   cancelWorkout={this.props.cancelWorkout} requestWorkoutChange={this.props.requestWorkoutChange} activities={this.props.activities} workoutItem={this.props.workoutItem} { ...this.state } confirmWorkout={this.props.trainerConfirmWorkoutRequest} updateNewPrice={(numberOfFriends) => this.getNewPrice(numberOfFriends)} requestNewWorkout={ (numberOfFriends) => this.requestNewWorkout(numberOfFriends)}  />
    )
  }
