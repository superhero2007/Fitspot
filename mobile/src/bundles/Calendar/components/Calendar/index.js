      ...
      return (
        ...
        <View style={styles.container}>
          <View style={{flexDirection:'row', position:'absolute', top:5,zIndex:5}}>
            ...
            <TouchableOpacity style={{paddingLeft:240,marginRight:10}} onPress={ this.goToWorkoutSession }>
              <Icon key={Math.random(5)} name="list" size={24}  style={{backgroundColor:'rgba(0,0,0,0)'}} color={DEFAULT_GREEN_COLOR}/>
            </TouchableOpacity>
          </View>
