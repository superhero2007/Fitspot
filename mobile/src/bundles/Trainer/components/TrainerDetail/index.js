      ...
      return(
        <TouchableHighlight key={data.lastName + data.firstName} onPress={() => component.cancel() } underlayColor={'#00000000'}>
          ...
          <View style={styles.trainerContainer}>
            { data.avatar ? <Image source={{uri: data.avatar.url}} style={{width:256,height:160}}/>
          : <Image source={require('@images/tab-profile.png')} style={{width:256,height:160}} resizeMode="center" />
            }
      ...
      <TouchableHighlight style={styles.container} onPress={() => this.props.onCancelClick() } underlayColor={'#00000000'}>
        <View style={{flex:1}}>
              <Carousel
                  ...
                  itemWidth={256}
                  autoplay={false}
                  firstItem={this.state.currentItem}
