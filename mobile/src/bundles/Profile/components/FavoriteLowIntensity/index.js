...
class FavoriteLowIntensity extends React.Component{
  ...
  constructor(props) {
    ...
    render() {
      ...
      return (
        ...
        <Button buttonStyle={[styles.buttonStyle,{marginTop:45}]} buttonTextStyle={styles.buttonTextStyle} onPress={() => {Actions.editProfileScene();}}>
          Save Low Intensity Workouts
        </Button>
        </View>
      );
    }
...
export default FavoriteLowIntensity
