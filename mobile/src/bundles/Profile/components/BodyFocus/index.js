...
class BodyFocus extends React.Component{
  ...
  renderOption(option, selected, onSelect, index){
    ...
    render() {
      ...
      return (
        ...
        <Button buttonStyle={[styles.buttonStyle,{marginTop:45}]} buttonTextStyle={styles.buttonTextStyle} onPress={Actions.trainingCadence}>
          Save Body Focus
        </Button>
        </View>
      );
