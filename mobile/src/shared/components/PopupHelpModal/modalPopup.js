...
import {View, Text, Image, Modal, TouchableHighlight,Linking} from 'react-native'
          ...
          <View style={{ height: 400, width: 280,}}>
            ...
            <View>
              ...
              <View style={{
                ...
                <Button onPress={() => Linking.openURL('mailto:info@fitspotapp.com?subject=App information')} buttonStyle={styles.modalButton} buttonTextStyle={styles.modalButtonText}>Chat</Button>
              </View>
            </View>
          </View>
    )
